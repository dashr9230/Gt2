...
// Original file: C:\CodePrj\Gt2\Engine\src\Debug.c

/*
 * ModName: .\Debug\Debug.obj
 * (000004) Start search for segment 0x1 at symbol 0x8C(000010) S_OBJNAME: Signature: 00000000, C:\CodePrj\Gt2\engine\Debug\Debug.obj
 * 
 * (000040) S_COMPILE:
 *          Language: C
 ...
 *          Flags: Frame Ptr Present
 * 
 * (0000F8)  S_BPREL32: [00000008], Type:      T_ULONG(0022), x
 * (000108)  S_BPREL32: [0000000C], Type:      T_ULONG(0022), y
 * (000118)  S_BPREL32: [00000010], Type:             0x16EA, FormatString
 * 
 * (000134)  S_BLOCK32: [0001:00097BBC], Cb: 0000004A, (none)
 *           Parent: 000000C4, End: 0000018C
 * 
 * (00014C)   S_BPREL32: [FFFFFDF8], Type:   T_32PRCHAR(0470), arglist
 * (000160)   S_BPREL32: [FFFFFDFC], Type:      T_ULONG(0022), StrLength
 * (000178)   S_BPREL32: [FFFFFE00], Type:             0x1550, Buffer
 * 
 * (00018C)  S_END
 * 
 * (000190) S_END
 ...
 *          Flags: Frame Ptr Present
 * 
 * (000200)  S_BPREL32: [00000008], Type:      T_ULONG(0022), fore
