...
// Original file: C:\CodePrj\Gt2\Engine\src\cleanup.c

/*
 * ModName: .\Debug\cleanup.obj
 * (000004) Start search for segment 0x1 at symbol 0x8C(000010) S_OBJNAME: Signature: 00000000, C:\CodePrj\Gt2\engine\Debug\cleanup.obj
 * 
 * (000040) S_COMPILE:
 *          Language: C
 ...
 *          Flags: Frame Ptr Present
 * 
 * (000114)  S_BPREL32: [00000008], Type:             0x16EA, errormsg
 * (00012C)  S_BPREL32: [FFFFFEFC], Type:             0x1A12, ErrorBuffer
 ...
 *          Flags: Frame Ptr Present
 * 
 * (000190)  S_BPREL32: [00000008], Type:             0x16EA, errormsg
 * (0001A8)  S_BPREL32: [FFFFFEFC], Type:             0x1A12, ErrorBuffer
